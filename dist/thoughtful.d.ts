...
declare module 'thoughtful' {
    export * from 'thoughtful/matrix';
    export * from 'thoughtful/NeuralNetworks/ann';
    export * from 'thoughtful/NeuralNetworks/activationFunctions';
    export * from 'thoughtful/NeuralNetworks/errorFunctions';
    export * from 'thoughtful/helper/utilities';
    export * from 'thoughtful/helper/classToValue';
    export * from 'thoughtful/helper/distances';
    export * from 'thoughtful/helper/normalization';
    export * from 'thoughtful/helper/maths';
    export * from 'thoughtful/helper/generators';
    export * from 'thoughtful/knn';
    export * from 'thoughtful/k-means';
}

declare module 'thoughtful/matrix' {
    export class Matrix {
        data: number[][];
...
declare module 'thoughtful/NeuralNetworks/ann' {
    import { ActivationFunction, ErrorFunction } from 'thoughtful/';
...
declare module 'thoughtful/NeuralNetworks/activationFunctions' {
...
declare module 'thoughtful/NeuralNetworks/errorFunctions' {
...
declare module 'thoughtful/helper/utilities' {
...
declare module 'thoughtful/helper/classToValue' {
...
declare module 'thoughtful/helper/distances' {
...
declare module 'thoughtful/helper/normalization' {
...
declare module 'thoughtful/helper/maths' {
    import { Matrix } from 'thoughtful/';
...
declare module 'thoughtful/helper/generators' {
...
declare module 'thoughtful/knn' {
    import { ClassToValue, NumericDistanceFunction } from 'thoughtful/';
...
declare module 'thoughtful/k-means' {
    import { NumericDistanceFunction } from 'thoughtful/';
    export class KMeans {
